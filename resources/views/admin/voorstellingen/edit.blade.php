<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Voorstelling Bewerken: {{ $voorstelling->title }}
        </h2>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-xl rounded-lg overflow-hidden">
                ...
                <form action="{{ route('admin.voorstellingen.update', $voorstelling) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="title" 
                               id="title" 
                               value="{{ old('title', $voorstelling->title) }}"
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Korte beschrijving van de voorstelling...">{{ old('description', $voorstelling->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="date" 
                                   name="date" 
                                   id="date" 
                                   value="{{ old('date', $voorstelling->date->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <input type="time" 
                                   name="time" 
                                   id="time" 
                                   value="{{ old('time', $voorstelling->time->format('H:i')) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="duration" 
                                   id="duration" 
                                   value="{{ old('duration', $voorstelling->duration) }}"
                                   min="1"
                                   max="600"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="price" 
                                   id="price" 
                                   value="{{ old('price', $voorstelling->price) }}"
                                   min="0"
                                   max="999.99"
                                   step="0.01"
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="max_capacity" 
                                   id="max_capacity" 
                                   value="{{ old('max_capacity', $voorstelling->max_capacity) }}"
                                   min="1"
                                   max="10000"
                    ...
                    <div>
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" 
                                   ...
                                   id="is_active" 
                                   value="1"
                                   {{ old('is_active', $voorstelling->is_active) ? 'checked' : '' }}
